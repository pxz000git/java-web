...
<%@page import="com.foda.web.servlet.cookie.util.CookieUtils "%>
	...
	<body>
		...
		<div style="width:1210px;margin:0 auto; padding: 0 9px;border: 1px solid #ddd;border-top: 2px solid #999;height: 246px;">
			...
			<div style="overflow: hidden;">
				...
				Cookie cook = 	CookieUtils.findCookie(cookie, "history");
				if(cook == null){
				%>
					<h2>您还没浏览任何商品</h2>
			...
			<a href="CleanCookie"><h2>清除浏览记录</h2></a>
		</div>
